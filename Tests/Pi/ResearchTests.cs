...
public sealed class ResearchTests
{
    ...
    public async Task OptInQueueAndDisableKeepWorkersIndependentAndBounded()
    {
        ...
        Assert.AreEqual(0, await coordinator.GetPendingCountAsync());
        ...
        Assert.AreEqual(3, await coordinator.GetPendingCountAsync());
        ...
        Assert.AreEqual(2, await coordinator.GetPendingCountAsync());
